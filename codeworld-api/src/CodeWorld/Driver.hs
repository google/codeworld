...
pictureToDrawing (Circle _ r) = Shape $ pathDrawer r 0 True False
pictureToDrawing (SolidCircle _ r) = Shape $ polygonDrawer r False
pictureToDrawing (ThickCircle _ r lw) = Shape $ pathDrawer r lw True False

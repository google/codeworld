    ...
    case mainPath of
        ...
        Nothing -> do
            ...
            let matched = [ src | (src, GHCParsed mod) <- zip srcs parsed
                                , isMainModName (GHC.hsmodName mod) ]

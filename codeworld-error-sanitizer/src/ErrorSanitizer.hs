...
filterStages = [
        ...
        (mkRegex "\xe2\x80\x99", ""),
        (mkRegex " \\[-W[a-z-]*\\]", ""),
        (mkRegex "IO action main", "variable program"),
        (mkRegex "main IO action", "variable"),
        (mkRegex "exported by", "defined in"),
        (mkRegex "module Main", "your code"),
        (mkRegex "main\\:Main", "your code"),
        (mkRegex "is applied to too few arguments", "is missing arguments"),
        ...
        (mkRegex "the first argument", "the argument(s)"),
        ...
        (mkRegex "[(]main[)]", "program"),
        (mkRegex "\\bmain\\b", "program"),
        (mkRegex "a pattern binding", "the definition"),

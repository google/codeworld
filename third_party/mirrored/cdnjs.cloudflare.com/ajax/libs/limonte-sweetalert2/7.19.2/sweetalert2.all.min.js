(function (e, t) {
  ...
  function t() {
    const e = Be.innerParams.get(this),
  ...
  function n(e) {
    ...
    for (
      let a = window.getComputedStyle(t).getPropertyValue("background-color"),
    ...
    if (
      ...
      "string" === typeof e.backdrop
        ? (I().style.background = e.backdrop)
        : !e.backdrop &&
          L([document.documentElement, document.body], k["no-backdrop"]),
      e.html ? ie(e.html, d) : e.text ? ((d.textContent = e.text), _(d)) : V(d),
      e.position in k
        ? L(i, k[e.position])
    ...
    "function" === typeof e.animation && (e.animation = e.animation.call()),
      e.showCloseButton
        ? (m.setAttribute("aria-label", e.closeButtonAriaLabel), _(m))
        : V(m),
      (t.className = k.popup),
      e.toast
    ...
    e.progressSteps && e.progressSteps.length
      ...
      : V(y);
    for (let w = M(), C = 0; C < w.length; C++) V(w[C]);
    if (e.type) {
      let x = !1;
      for (const A in B) {
        if (e.type === A) {
      ...
      const E = t.querySelector(`.${k.icon}.${B[e.type]}`);
    ...
    if (
      ...
      e.showConfirmButton || e.showCancelButton ? _(u) : V(u),
  ...
  var a =
    ...
    s =
      ...
      function (e) {
        for (var t, n = 1; n < arguments.length; n++) {
          for (const o in ((t = arguments[n]), t)) {
      ...
      argsToParams: function (e) {
        ...
        switch (a(e[0])) {
          ...
          default:
            return (
              h(
                `Unexpected type of argument! Expected "string" or "object", got ${a(
                  e[0]
                )}`
              ),
              !1
    ...
    Se = Object.freeze({
      ...
      disableLoading: t,
      getInput: function (e) {
        const t = Be.innerParams.get(this),
      ...
      showValidationError: function (e) {
        ...
        const n = window.getComputedStyle(t.popup);
        (t.validationError.style.marginLeft = `-${n.getPropertyValue(
          "padding-left"
        )}`),
          (t.validationError.style.marginRight = `-${n.getPropertyValue(
            "padding-right"
          )}`),
          _(t.validationError);
      ...
      _main: function (e) {
        ...
        return new Promise((e, n) => {
          ...
          const C = function (e, t) {
            for (let n = Z(o.focusCancel), i = 0; i < n.length; i++) {
              (e += t),
          ...
          for (
            ...
            if (((B = t.getInput(x[A])), B)) {
              for (const O in B.attributes) {
                if (B.attributes.hasOwnProperty(O)) {
                  const q = B.attributes[O].name;
                  "type" !== q && "value" !== q && B.removeAttribute(q);
                }
              }
              for (const j in o.inputAttributes) {
          ...
          switch (o.input) {
              ...
              (U.innerHTML = ""),
                (R = function (e) {
                  e.forEach((e) => {
                    ...
                    _(U);
                  const t = U.querySelectorAll("input");
                  t.length && t[0].focus();
                });
              break;
            case "checkbox":
            ...
            default:
              h(
                `Unexpected type of input! Expected "text", "email", "password", "number", "tel", "select", "radio", "checkbox", "textarea", "file" or "url", got "${o.input}"`
              );
          }
          if ("select" === o.input || "radio" === o.input) {
            ...
            w(o.inputOptions)
              ? (l.showLoading(),
                o.inputOptions.then((e) => {
                  t.hideLoading(), Y(e);
                }))
              : "object" === a(o.inputOptions)
              ? Y(o.inputOptions)
              : h(
                  `Unexpected type of inputOptions! Expected object, Map or Promise, got ${a(
                    o.inputOptions
                  )}`
                );
          } else {
          ...
          Ee(o.animation, o.onBeforeOpen, o.onOpen),
            o.toast ||
              (v(o.allowEnterKey)
  ...
  (o.prototype.then = function (e, t) {
    const n = Be.promise.get(this);
    return n.then(e, t);
  }),
    (o.prototype.catch = function (e) {
      const t = Be.promise.get(this);
      return t.catch(e);
    }),

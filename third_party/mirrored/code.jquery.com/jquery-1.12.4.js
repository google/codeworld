...
(function (global, factory) {
  ...
  function isArrayLike(obj) {
    ...
    const length = Boolean(obj) && "length" in obj && obj.length,
        ...
        pseudos: {
          ...
          focus: function (elem) {
            return (
              ...
              Boolean(elem.type || elem.href || ~elem.tabIndex)
            );
          },
          ...
          checked: function (elem) {
            ...
            return (
              (nodeName === "input" && Boolean(elem.checked)) ||
              (nodeName === "option" && Boolean(elem.selected))
            );
          },
  ...
  const acceptData = function (elem) {
    const noData = jQuery.noData[`${elem.nodeName} `.toLowerCase()],
      nodeType = Number(elem.nodeType) || 1;
  ...
  function adjustCSS(elem, prop, valueParts, tween) {
    let adjusted,
      ...
      initialInUnit =
        (jQuery.cssNumber[prop] || (unit !== "px" && Number(initial))) &&
  ...
  (function () {
    ...
    support.htmlSerialize = Boolean(div.getElementsByTagName("link").length);
    ...
    support.noCloneChecked = Boolean(
    ...
    support.noCloneEvent = Boolean(div.addEventListener);
  ...
  (function () {
    ...
    support.cssFloat = Boolean(div.style.cssFloat);
  ...
  (function () {
    ...
    support.checkOn = Boolean(input.value);
    ...
    support.enctype = Boolean(document.createElement("form").enctype);
  ...
  xhrSupported = support.ajax = Boolean(xhrSupported);

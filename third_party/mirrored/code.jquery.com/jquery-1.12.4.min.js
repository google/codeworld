...
!(function (a, b) {
  ...
  (n.filter = function (a, b, c) {
    ...
    n.fn.extend({
      ...
      is: function (a) {
        return Boolean(
          z(this, "string" === typeof a && w.test(a) ? n(a) : a || [], !1)
            .length
        );
      },
    });
  ...
  function X(a, b, c, d) {
    let e,
      ...
      k = (n.cssNumber[b] || ("px" !== j && Number(i))) && U.exec(n.css(a, b));
    if (k && k[3] !== j) {
      (j = j || k[3]), (c = c || []), (k = Number(i) || 1);
      do (f = f || ".5"), (k /= f), n.style(a, b, k + j);
      while (f !== (f = h() / i) && 1 !== f && --g);
    }
    return (
      c &&
        ((k = Number(k) || Number(i) || 0),
  ...
  !(function () {
    ...
    (a.innerHTML =
      ...
      (l.htmlSerialize = Boolean(a.getElementsByTagName("link").length)),
      (l.html5Clone =
      ...
      (l.noCloneChecked = Boolean(a.cloneNode(!0).lastChild.defaultValue)),
      b.appendChild(a),
      (c = d.createElement("input")),
      ...
      (l.noCloneEvent = Boolean(a.addEventListener)),
      (a[n.expando] = 1),
  ...
  !(function () {
    ...
    if (j.style) {
      (j.style.cssText = "float:left;opacity:.5"),
        ...
        (l.cssFloat = Boolean(j.style.cssFloat)),
  ...
  n.extend({
    ...
    (n.cssHooks.marginRight = Ua(l.reliableMarginRight, (a, b) => {
      return b
        ? Pa(a, { display: "inline-block" }, Sa, [a, "marginRight"])
        : void 0;
    })),
    (n.cssHooks.marginLeft = Ua(l.reliableMarginLeft, (a, b) => {
      return b
        ? `${
  ...
  (n.Animation = n.extend(qb, {
    ...
    (function () {
      ...
      (c = d.createElement("div")),
        ...
        (l.checkOn = Boolean(b.value)),
        (l.optSelected = f.selected),
        (l.enctype = Boolean(d.createElement("form").enctype)),
        (e.disabled = !0),
  ...
  a.attachEvent &&
    ...
    (l.cors = Boolean(gc) && "withCredentials" in gc),
    (gc = l.ajax = Boolean(gc)),
    gc &&
      n.ajaxTransport((b) => {
  ...
  (n.offset = {
    ...
    n.each(["top", "left"], (a, b) => {
      n.cssHooks[b] = Ua(l.pixelPosition, (a, c) => {
        return c

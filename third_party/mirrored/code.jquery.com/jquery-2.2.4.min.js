...
!(function (a, b) {
  ...
  var K = function (a, b, c, d, e, f, g) {
    ...
    L = function (a) {
      return 1 === a.nodeType || 9 === a.nodeType || !Number(a.nodeType);
    };
  function M() {
  ...
  function W(a, b, c, d) {
    let e,
      ...
      k = (n.cssNumber[b] || ("px" !== j && Number(i))) && T.exec(n.css(a, b));
    if (k && k[3] !== j) {
  ...
  (l.cors = Boolean(Ib) && "withCredentials" in Ib),
    (l.ajax = Ib = Boolean(Ib)),
    n.ajaxTransport((b) => {
      let c, d;

...
(function (t) {
  ...
  function a(e, i) {
    t.extend(e, i);
    for (const s in i) null == i[s] && (e[s] = i[s]);
    return e;
  }
  function r(t) {
    return function () {
  ...
  (t.cleanData = (function (e) {
    ...
    (t.Widget.prototype = {
      ...
      _toggleClass: function (t, e, i, s) {
        ...
        const n = "string" === typeof t || null === t,
          o = {
            extra: n ? e : i,
            keys: n ? t : e,
    ...
    t.extend(t.expr[":"], {
      data: t.expr.createPseudo
        ? t.expr.createPseudo((e) => {
            return function (i) {
              return Boolean(t.data(i, e));
            };
          })
        : function (e, i, s) {
            return Boolean(t.data(e, s[3]));
          },
    }),
    t.fn.extend({
      ...
      t.expr &&
        ...
        t.extend(t.effects, {
          ...
          scaledDimensions: function (t, e, i) {
            ...
            const s = "horizontal" !== i ? (e || 100) / 100 : 1,
    ...
    t.widget("ui.accordion", {
      ...
      _setOptionDisabled: function (t) {
        this._super(t),
          ...
          this._toggleClass(null, "ui-state-disabled", Boolean(t)),
          this._toggleClass(
    ...
    t.widget("ui.menu", {
      ...
      refresh: function () {
        ...
        this._toggleClass(
          "ui-menu-icons",
          null,
          Boolean(this.element.find(".ui-icon").length)
        ),
          (s = h
            .filter(":not(.ui-menu)")
            .hide()
  ...
  t.widget("ui.controlgroup", {
    ...
    _buildSimpleOptions: function (t, e) {
      const i = "vertical" === this.options.direction,
        s = { classes: {} };
      return (
        (s.classes[e] = {
          middle: "",
    ...
    _selectmenuOptions: function (t) {
      const e = "vertical" === this.options.direction;
      return {
        width: e ? "auto" : !1,
        classes: {
          middle: {
  ...
  t.extend(s.prototype, {
        ...
        switch (e.keyCode) {
          ...
          case 34:
            t.datepicker._adjustDate(
              e.target,
              e.ctrlKey
                ? Number(t.datepicker._get(o, "stepBigMonths"))
                : Number(t.datepicker._get(o, "stepMonths")),
              "M"
            );
            break;
          case 35:
    ...
    _attachHandlers: function (e) {
      ...
      e.dpDiv.find("[data-handler]").map(function () {
        const e = {
          ...
          next: function () {
            t.datepicker._adjustDate(s, Number(i), "M");
          },
          hide: function () {
            t.datepicker._hideDatepicker();
          },
    ...
    _adjustInstDate: function (t, e, i) {
      const s = t.selectedYear + ("Y" === i ? e : 0),
    ...
    t.datepicker,
    (t.ui.ie = Boolean(/msie [\w.]+/.exec(navigator.userAgent.toLowerCase())));
  let _ = !1;
  t(document).on("mouseup", () => {
    ...
    t.widget("ui.mouse", {
      ...
      _mouseInit: function () {
        const e = this;
        this.element
          .on(`mousedown.${this.widgetName}`, (t) => {
    ...
    t.widget("ui.draggable", t.ui.mouse, {
      ...
      _adjustOffsetFromHelper: function (e) {
        "string" === typeof e && (e = e.split(" ")),
          t.isArray(e) && (e = { left: Number(e[0]), top: Number(e[1]) || 0 }),
    ...
    t.ui.plugin.add("draggable", "stack", {
      start: function (e, i, s) {
        let n,
          o = s.options,
          a = t.makeArray(t(o.stack)).sort((e, i) => {
            return (
    ...
    t.widget("ui.resizable", t.ui.mouse, {
      ...
      _create: function () {
        ...
        this._addClass("ui-resizable"),
          t.extend(this, {
            _aspectRatio: Boolean(i.aspectRatio),
    ...
    t.widget("ui.dialog", {
      ...
      _moveToTop: function (e, i) {
        let s = !1,
          n = this.uiDialog
            ...
            .map(function () {
              return Number(t(this).css("z-index"));
            })
            .get(),
          o = Math.max.apply(null, n);
        return (
          o >= Number(this.uiDialog.css("z-index")) &&
      ...
      _allowInteraction: function (e) {
        return t(e.target).closest(".ui-dialog").length
          ? !0
          : Boolean(t(e.target).closest(".ui-datepicker").length);
      },
  ...
  (t.ui.ddmanager = {
    ...
    t.widget("ui.spinner", {
      ...
      _setOptionDisabled: function (t) {
        this._super(t),
          ...
          this.element.prop("disabled", Boolean(t)),
    ...
    t.widget("ui.tabs", {
      ...
      refresh: function () {
        ...
        (e.disabled = t.map(i.filter(".ui-state-disabled"), (t) => {
          return i.index(t);
        })),
          this._processTabs(),

...
Blockly.Blocks["cwCombine"] = {
  init() {
    ...
    this.appendValueInput("PIC1").appendField(
  ...
  getExpr() {
    ...
    if (exps.length < 2) {
      // If the block has less than 2 inputs, warn the user
      exps = [];
      exps.push(Exp.Var("undef"));
      exps.push(Exp.Var("undef"));
    }
  ...
  decompose(workspace) {
    const containerBlock = workspace.newBlock("pics_combine_container");
...
Blockly.Blocks["pics_combine_container"] = {
  init() {
    this.setColour(picsHUE);
    this.appendDummyInput().appendField("Picture inputs");
...
Blockly.Blocks["lists_pictures"] = {
  init() {
    ...
    Blockly.TypeInf.defineFunction(
      "pictures",
      Type.fromList([Type.Lit("list", [pic]), pic])
    );
...
Blockly.Blocks["lists_polyline"] = {
  init() {
    ...
    Blockly.TypeInf.defineFunction(
      "polyline",
      Type.fromList([Type.Lit("list", [pair]), Type.Lit("Picture")])
    );
...
Blockly.Blocks["lists_thickPolyline"] = {
  init() {
    ...
    Blockly.TypeInf.defineFunction(
      "thickPolyline",
      Type.fromList([pts, num, Type.Lit("Picture")])
    );
...
Blockly.Blocks["lists_solidClosedCurve"] = {
  init() {
    ...
    this.appendValueInput("LST")
      .appendField(
        new Blockly.FieldLabel("solidClosedCurve", "blocklyTextEmph")
      )
      .appendField("(");
    this.appendDummyInput().setAlign(Blockly.ALIGN_RIGHT).appendField(")");
    this.setInputsInline(false);
...
Blockly.Blocks["lists_thickClosedCurve"] = {
  init() {
    ...
    this.appendValueInput("LST")
      .appendField(
        new Blockly.FieldLabel("thickClosedCurve", "blocklyTextEmph")
      )
      .appendField("(");
    this.appendValueInput("THICKNESS")
      .setAlign(Blockly.ALIGN_RIGHT)
